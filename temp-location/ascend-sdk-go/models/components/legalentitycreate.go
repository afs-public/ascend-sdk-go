...
func (e *BusinessIndustrialClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "PUBLIC_ADMINISTRATION":
		*e = BusinessIndustrialClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BusinessIndustrialClassification: %v", v)
	}
}
...
func (e *CorporateStructure) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "CORPORATION_NONPROFIT":
		*e = CorporateStructure(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CorporateStructure: %v", v)
	}
}
...
func (e *ExemptCustomerReason) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "STATE_REGULATED_INSURANCE_COMPANY":
		*e = ExemptCustomerReason(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ExemptCustomerReason: %v", v)
	}
}
...
func (e *LegalEntityCreateTaxIDType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "TAX_ID_TYPE_EIN":
		*e = LegalEntityCreateTaxIDType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for LegalEntityCreateTaxIDType: %v", v)
	}
}
