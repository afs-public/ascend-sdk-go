...
* [GetPreIpoCompanyNewsEvent](#getpreipocompanynewsevent) - Get Pre IPO Company Event
...
## GetPreIpoCompanyNewsEvent

Gets a Pre IPO Company News Event.

### Example Usage

<!-- UsageSnippet language="go" operationID="PreIpoCompanyNewsEvents_GetPreIpoCompanyNewsEvent" method="get" path="/trading/v1/preIpoCompanies/{preIpoCompany_id}/newsEvents/{newsEvent_id}" -->
```go
package main
...
func main() {
    ...
    res, err := s.PreIPONewsEvents.GetPreIpoCompanyNewsEvent(ctx, "3fa85f64-5717-4562-b3fc-2c963f66afa6", "019af223-10eb-7ea4-861f-a1c283e035a2")
    if err != nil {
        log.Fatal(err)
    }
    if res.PreIpoCompanyNewsEvent != nil {
        // handle response
    }
}
```
...
| `ctx`                                                    | [context.Context](https://pkg.go.dev/context#Context)    | :heavy_check_mark:                                       | The context to use for the request.                      |                                                          |
| `preIpoCompanyID`                                        | *string*                                                 | :heavy_check_mark:                                       | The preIpoCompany id.                                    | 3fa85f64-5717-4562-b3fc-2c963f66afa6                     |
| `newsEventID`                                            | *string*                                                 | :heavy_check_mark:                                       | The newsEvent id.                                        | 019af223-10eb-7ea4-861f-a1c283e035a2                     |
| `opts`                                                   | [][operations.Option](../../models/operations/option.md) | :heavy_minus_sign:                                       | The options for this request.                            |                                                          |

### Response

**[*operations.PreIpoCompanyNewsEventsGetPreIpoCompanyNewsEventResponse](../../models/operations/preipocompanynewseventsgetpreipocompanynewseventresponse.md), error**
