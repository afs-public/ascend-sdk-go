...
func main() {
    ...
    res, err := s.AccountManagement.UpdateAccount(ctx, "01HC3MAQ4DR9QN1V8MJ4CN1HMK", components.AccountRequestUpdate{}, ascendsdkgo.String("[object Object]"))
    if err != nil {
        log.Fatal(err)
    }
    if res.Account != nil {
...
<!-- UsageSnippet language="go" operationID="Accounts_UpdateAccountGroup" method="put" path="/accounts/v1/accounts/{account_id}:updateAccountGroup" -->
```go
package main
...
func main() {
    ...
    res, err := s.AccountManagement.UpdateAccountGroup(ctx, "01HC3MAQ4DR9QN1V8MJ4CN1HMK", components.UpdateAccountGroupRequestUpdate{})
    if err != nil {
        log.Fatal(err)
    }
    if res.Account != nil {
...
**[*operations.AccountsUpdateAccountGroupResponse](../../models/operations/accountsupdateaccountgroupresponse.md), error**
...
func main() {
    ...
    res, err := s.AccountManagement.UpdateParty(ctx, "01HC3MAQ4DR9QN1V8MJ4CN1HMK", "a58ddb02-3954-4249-a7d5-1d408def12cf", components.PartyRequestUpdate{}, ascendsdkgo.String("[object Object]"))
    if err != nil {
        log.Fatal(err)
    }
    if res.Party != nil {
...
func main() {
    ...
    res, err := s.AccountManagement.UpdateTrustedContact(ctx, "01HC3MAQ4DR9QN1V8MJ4CN1HMK", "8096110d-fb55-4f9d-b883-b84f0b70d3ea", components.TrustedContactUpdate{}, ascendsdkgo.String("[object Object]"))
    if err != nil {
        log.Fatal(err)
    }
    if res.TrustedContact != nil {
...
func main() {
    ...
    res, err := s.AccountManagement.UpdateInterestedParty(ctx, "01HC3MAQ4DR9QN1V8MJ4CN1HMK", "ecf44f2f-7030-48ed-b937-c40891ee10c8", components.InterestedPartyUpdate{}, ascendsdkgo.String("[object Object]"))
    if err != nil {
        log.Fatal(err)
    }
    if res.InterestedParty != nil {
...
<!-- UsageSnippet language="go" operationID="Accounts_CreateNote" method="post" path="/accounts/v1/accounts/{account_id}/notes" -->
```go
package main
...
func main() {
    ...
    res, err := s.AccountManagement.CreateNote(ctx, "01HC3MAQ4DR9QN1V8MJ4CN1HMK", components.NoteCreate{
...
**[*operations.AccountsCreateNoteResponse](../../models/operations/accountscreatenoteresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="Accounts_ListNotes" method="get" path="/accounts/v1/accounts/{account_id}/notes" -->
```go
package main
...
func main() {
    ...
    res, err := s.AccountManagement.ListNotes(ctx, "01HC3MAQ4DR9QN1V8MJ4CN1HMK", ascendsdkgo.Int(50), ascendsdkgo.String("eyJvZmZzZXQiOjUwfQ=="), ascendsdkgo.String("create_time desc"))
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.AccountsListNotesResponse](../../models/operations/accountslistnotesresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="Accounts_GetNote" method="get" path="/accounts/v1/accounts/{account_id}/notes/{note_id}" -->
```go
package main
...
func main() {
    ...
    res, err := s.AccountManagement.GetNote(ctx, "01HC3MAQ4DR9QN1V8MJ4CN1HMK", "8096110d-fb55-4f9d-b883-b84f0b70d3ea")
    if err != nil {
        log.Fatal(err)
    }
    if res.Note != nil {
...
**[*operations.AccountsGetNoteResponse](../../models/operations/accountsgetnoteresponse.md), error**
