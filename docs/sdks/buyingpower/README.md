...
func main() {
    ...
    res, err := s.BuyingPower.GetBuyingPower(ctx, "01HMS9S15AKBHBD8GPW33P2PMH")
    if err != nil {
        log.Fatal(err)
    }
...
<!-- UsageSnippet language="go" operationID="MarginsRealTime_GetAssetBuyingPower" method="get" path="/buyingpower/v1/accounts/{account_id}/assets/{asset_id}/buyingPower" -->
```go
package main
...
func main() {
    ...
    res, err := s.BuyingPower.GetAssetBuyingPower(ctx, "01HMS9S15AKBHBD8GPW33P2PMH", "67587")
    if err != nil {
        log.Fatal(err)
    }
    if res.AssetBuyingPower != nil {
        // handle response
    }
}
```
...
**[*operations.MarginsRealTimeGetAssetBuyingPowerResponse](../../models/operations/marginsrealtimegetassetbuyingpowerresponse.md), error**
