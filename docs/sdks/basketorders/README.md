...
func main() {
    ...
    res, err := s.BasketOrders.SetExtraReportingData(ctx, "01HPMZZM6RKMVZA1JQ63RQKJRP", "fffd326-72fa-4d2b-bd1f-45384fe5d521", components.BasketTradingSetExtraReportingDataRequestCreate{
