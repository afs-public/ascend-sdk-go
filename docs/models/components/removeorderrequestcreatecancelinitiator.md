...
| Name                                                          | Value                                                         |
| ------------------------------------------------------------- | ------------------------------------------------------------- |
| `RemoveOrderRequestCreateCancelInitiatorInitiatorUnspecified` | INITIATOR_UNSPECIFIED                                         |
| `RemoveOrderRequestCreateCancelInitiatorFirm`                 | FIRM                                                          |
| `RemoveOrderRequestCreateCancelInitiatorClient`               | CLIENT                                                        |