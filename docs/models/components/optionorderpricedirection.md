...
| Name                                                  | Value                                                 |
| ----------------------------------------------------- | ----------------------------------------------------- |
| `OptionOrderPriceDirectionDebitCreditTypeUnspecified` | DEBIT_CREDIT_TYPE_UNSPECIFIED                         |
| `OptionOrderPriceDirectionDebit`                      | DEBIT                                                 |
| `OptionOrderPriceDirectionCredit`                     | CREDIT                                                |