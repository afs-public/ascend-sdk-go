...
| Name                                                | Value                                               |
| --------------------------------------------------- | --------------------------------------------------- |
| `SetExtraReportingDataResponseIdentifierTypeSymbol` | SYMBOL                                              |
| `SetExtraReportingDataResponseIdentifierTypeCusip`  | CUSIP                                               |
| `SetExtraReportingDataResponseIdentifierTypeIsin`   | ISIN                                                |