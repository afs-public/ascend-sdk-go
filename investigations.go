...
func (s *Investigations) CreateIdentityLookup(ctx context.Context, correspondentID string, identityLookupCreate components.IdentityLookupCreate, opts ...operations.Option) (*operations.IdentityLookupServiceCreateIdentityLookupResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/cip/v1/correspondents/{correspondent_id}/identityLookups", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "IdentityLookupCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"400", "403", "404", "429", "4XX", "500", "5XX"}, httpRes.StatusCode) {
			_httpRes, err := s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, httpRes, nil)
			if err != nil {
				return nil, err
			} else if _httpRes != nil {
	...
	res := &operations.IdentityLookupServiceCreateIdentityLookupResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.IdentityLookup
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.IdentityLookup = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Investigations) VerifyIdentityLookup(ctx context.Context, correspondentID string, identityLookupID string, verifyIdentityLookupRequestCreate components.VerifyIdentityLookupRequestCreate, opts ...operations.Option) (*operations.IdentityLookupServiceVerifyIdentityLookupResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/cip/v1/correspondents/{correspondent_id}/identityLookups/{identityLookup_id}:verify", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "VerifyIdentityLookupRequestCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"400", "401", "403", "404", "429", "4XX", "500", "504", "5XX"}, httpRes.StatusCode) {
			_httpRes, err := s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, httpRes, nil)
			if err != nil {
				return nil, err
			} else if _httpRes != nil {
	...
	res := &operations.IdentityLookupServiceVerifyIdentityLookupResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
