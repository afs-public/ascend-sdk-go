...
func TestPreIpoResearchDocuments_PreIpoCompanyResearchDocumentsListPreIpoCompanyResearchDocuments(t *testing.T) {
	ctx := context.Background()

	testHTTPClient := createTestHTTPClient("PreIpoCompanyResearchDocuments_ListPreIpoCompanyResearchDocuments")
	...
	res, err := s.PreIPOResearchDocuments.ListPreIpoCompanyResearchDocuments(ctx, "a6c63e95-fe8a-4703-a74a-f2a90c0a9c6d", ascendsdkgo.Int(25), ascendsdkgo.String(""), ascendsdkgo.String(""))
