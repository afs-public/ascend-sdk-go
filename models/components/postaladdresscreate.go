...
// PostalAddressCreate - Represents a postal address, e.g. for postal delivery or payments addresses. Given a postal address, a postal service can deliver items to a premise, P.O. Box or similar. It is not intended to model geographical locations (roads, towns, mountains).
//
...
func (o *PostalAddressCreate) GetAddressLines() []string {
	if o == nil {
		return nil
	}
...
func (o *PostalAddressCreate) GetAdministrativeArea() *string {
	if o == nil {
		return nil
	}
...
func (o *PostalAddressCreate) GetLanguageCode() *string {
	if o == nil {
		return nil
	}
...
func (o *PostalAddressCreate) GetLocality() *string {
	if o == nil {
		return nil
	}
	return o.Locality
...
func (o *PostalAddressCreate) GetOrganization() *string {
	if o == nil {
		return nil
	}
...
func (o *PostalAddressCreate) GetPostalCode() *string {
	if o == nil {
		return nil
	}
	return o.PostalCode
...
func (o *PostalAddressCreate) GetRecipients() []string {
	if o == nil {
		return nil
	}
	return o.Recipients
...
func (o *PostalAddressCreate) GetRegionCode() *string {
	if o == nil {
		return nil
	}
	return o.RegionCode
...
func (o *PostalAddressCreate) GetRevision() *int {
	if o == nil {
		return nil
	}
	return o.Revision
...
func (o *PostalAddressCreate) GetSortingCode() *string {
	if o == nil {
		return nil
	}
...
func (o *PostalAddressCreate) GetSublocality() *string {
	if o == nil {
		return nil
	}
