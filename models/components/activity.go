...
// ActivityAccountTransferType - The type of asset movement being performed within the lifecycle of an account transfer process
type ActivityAccountTransferType string

const (
	ActivityAccountTransferTypeAccountTransferTypeUnspecified ActivityAccountTransferType = "ACCOUNT_TRANSFER_TYPE_UNSPECIFIED"
	ActivityAccountTransferTypePartialTransferReceiver        ActivityAccountTransferType = "PARTIAL_TRANSFER_RECEIVER"
	ActivityAccountTransferTypePartialTransferDeliverer       ActivityAccountTransferType = "PARTIAL_TRANSFER_DELIVERER"
	ActivityAccountTransferTypeFullAccountTransfer            ActivityAccountTransferType = "FULL_ACCOUNT_TRANSFER"
	ActivityAccountTransferTypeResidualCredit                 ActivityAccountTransferType = "RESIDUAL_CREDIT"
	ActivityAccountTransferTypeMutualFundCleanup              ActivityAccountTransferType = "MUTUAL_FUND_CLEANUP"
...
type ActivityAccountTransfer struct {
	...
	AccountTransferType *ActivityAccountTransferType `json:"account_transfer_type,omitempty"`
...
func (o *ActivityAccountTransfer) GetAccountTransferType() *ActivityAccountTransferType {
	if o == nil {
		return nil
	}
...
func (o *ActivityAccountTransfer) GetGiftTransfer() *bool {
	if o == nil {
		return nil
	}
...
const (
	...
	ActivityDistributionTypeQualifiedCharitableDistribution            ActivityDistributionType = "QUALIFIED_CHARITABLE_DISTRIBUTION"
)
