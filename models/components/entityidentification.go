...
func (e *EntityIdentificationType) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "LEI":
		fallthrough
	case "DUNS":
		*e = EntityIdentificationType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EntityIdentificationType: %v", v)
	}
}
