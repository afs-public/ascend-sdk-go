...
// TrustedContactCreate - A Trusted Contact is a person designated to verify the well being of the account holder. Only one form of contact information is required; An account may contain zero, one, or many.
type TrustedContactCreate struct {
...
func (o *TrustedContactCreate) GetEmailAddress() *string {
	if o == nil {
		return nil
	}
...
func (o *TrustedContactCreate) GetFamilyName() string {
	if o == nil {
		return ""
	}
	return o.FamilyName
...
func (o *TrustedContactCreate) GetGivenName() string {
	if o == nil {
		return ""
	}
	return o.GivenName
...
func (o *TrustedContactCreate) GetMailingAddress() *PostalAddressCreate {
	if o == nil {
		return nil
	}
...
func (o *TrustedContactCreate) GetMiddleNames() *string {
	if o == nil {
		return nil
	}
...
func (o *TrustedContactCreate) GetPhoneNumber() *PhoneNumberCreate {
	if o == nil {
		return nil
	}
