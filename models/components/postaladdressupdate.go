...
// PostalAddressUpdate - Represents a postal address, e.g. for postal delivery or payments addresses. Given a postal address, a postal service can deliver items to a premise, P.O. Box or similar. It is not intended to model geographical locations (roads, towns, mountains).
//
...
func (o *PostalAddressUpdate) GetAddressLines() []string {
	if o == nil {
		return nil
	}
...
func (o *PostalAddressUpdate) GetAdministrativeArea() *string {
	if o == nil {
		return nil
	}
...
func (o *PostalAddressUpdate) GetLanguageCode() *string {
	if o == nil {
		return nil
	}
...
func (o *PostalAddressUpdate) GetLocality() *string {
	if o == nil {
		return nil
	}
	return o.Locality
...
func (o *PostalAddressUpdate) GetOrganization() *string {
	if o == nil {
		return nil
	}
...
func (o *PostalAddressUpdate) GetPostalCode() *string {
	if o == nil {
		return nil
	}
	return o.PostalCode
...
func (o *PostalAddressUpdate) GetRecipients() []string {
	if o == nil {
		return nil
	}
	return o.Recipients
...
func (o *PostalAddressUpdate) GetRegionCode() *string {
	if o == nil {
		return nil
	}
	return o.RegionCode
...
func (o *PostalAddressUpdate) GetRevision() *int {
	if o == nil {
		return nil
	}
	return o.Revision
...
func (o *PostalAddressUpdate) GetSortingCode() *string {
	if o == nil {
		return nil
	}
...
func (o *PostalAddressUpdate) GetSublocality() *string {
	if o == nil {
		return nil
	}
