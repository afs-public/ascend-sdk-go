...
type PhoneNumberCreate struct {
	...
	ShortCode *PhoneNumberShortCodeCreate `json:"short_code,omitempty"`
}

func (o *PhoneNumberCreate) GetE164Number() *string {
	if o == nil {
		return nil
	}
	return o.E164Number
...
func (o *PhoneNumberCreate) GetExtension() *string {
	if o == nil {
		return nil
	}
	return o.Extension
...
func (o *PhoneNumberCreate) GetShortCode() *PhoneNumberShortCodeCreate {
	if o == nil {
		return nil
	}
	return o.ShortCode
