...
func (o *PriceAdjustmentRecord) GetPriceAdjustmentAmount() *EntryPriceAdjustmentAmount {
	if o == nil {
		return nil
	}
...
func (o *PriceAdjustmentRecord) GetPriceAdjustmentType() *EntryPriceAdjustmentType {
	if o == nil {
		return nil
	}
...
func (o *Allocation) GetAdditionalInstructions() []string {
	if o == nil {
		return nil
	}
	return o.AdditionalInstructions
...
func (o *Allocation) GetBookingAPITradeAllocationID() *string {
	if o == nil {
		return nil
	}
...
func (o *Allocation) GetBrokerCapacity() *EntryBrokerCapacity {
	if o == nil {
		return nil
	}
...
func (o *Allocation) GetClientMemo() *string {
	if o == nil {
		return nil
	}
	return o.ClientMemo
...
func (o *Allocation) GetClientOrderID() *string {
	if o == nil {
		return nil
	}
...
func (o *Allocation) GetExternalID() *string {
	if o == nil {
		return nil
	}
	return o.ExternalID
...
func (o *Allocation) GetGatewayClientOrderID() *string {
	if o == nil {
		return nil
	}
...
func (o *Allocation) GetInternalError() *bool {
	if o == nil {
		return nil
	}
...
func (o *Allocation) GetPrevailingMarketPrice() *EntryPrevailingMarketPrice {
	if o == nil {
		return nil
	}
...
func (o *Allocation) GetPriceAdjustmentRecord() *PriceAdjustmentRecord {
	if o == nil {
		return nil
	}
...
func (o *Allocation) GetSpecialInstructions() []string {
	if o == nil {
		return nil
	}
...
func (o *Allocation) GetYieldRecords() []YieldRecord {
	if o == nil {
		return nil
	}
...
type EntryBondDefaultQuantity struct {
	// The decimal value, as a string; Refer to [Google’s Decimal type protocol buffer](https://github.com/googleapis/googleapis/blob/40203ca1880849480bbff7b8715491060bbccdf1/google/type/decimal.proto#L33) for details
	Value *string `json:"value,omitempty"`
}

func (o *EntryBondDefaultQuantity) GetValue() *string {
	if o == nil {
		return nil
	}
	return o.Value
...
type BondDefault struct {
	...
	Quantity *EntryBondDefaultQuantity `json:"quantity,omitempty"`
}

func (o *BondDefault) GetCashRate() *CashRate {
	if o == nil {
		return nil
	}
	return o.CashRate
...
func (o *BondDefault) GetCorporateActionGeneralInformation() *EntryCorporateActionGeneralInformation {
	if o == nil {
		return nil
	}
	return o.CorporateActionGeneralInformation
...
func (o *BondDefault) GetPaymentDate() *PaymentDate {
	if o == nil {
		return nil
	}
...
func (o *BondDefault) GetQuantity() *EntryBondDefaultQuantity {
	if o == nil {
		return nil
	}
	return o.Quantity
...
type EntryCapitalGainsCorporateActionGeneralInformation struct {
	// A unique alphanumeric value that is assigned to uniquely identify each corporate action event
	CorporateActionID *string `json:"corporate_action_id,omitempty"`
	// Asset Id of the new security after the corporate action event is processed
	DisbursedAssetID *string `json:"disbursed_asset_id,omitempty"`
...
func (o *EntryCapitalGainsCorporateActionGeneralInformation) GetCorporateActionID() *string {
	if o == nil {
		return nil
	}
	return o.CorporateActionID
...
func (o *EntryCapitalGainsCorporateActionGeneralInformation) GetDisbursedAssetID() *string {
	if o == nil {
		return nil
	}
	return o.DisbursedAssetID
...
func (o *EntryCapitalGainsCorporateActionGeneralInformation) GetDisbursedCusip() *string {
	if o == nil {
		return nil
	}
	return o.DisbursedCusip
...
func (o *EntryCapitalGainsCorporateActionGeneralInformation) GetDisbursedSymbolDescription() *string {
	if o == nil {
		return nil
	}
	return o.DisbursedSymbolDescription
...
func (o *EntryCapitalGainsCorporateActionGeneralInformation) GetTargetAssetID() *string {
	if o == nil {
		return nil
	}
	return o.TargetAssetID
...
func (o *EntryCapitalGainsCorporateActionGeneralInformation) GetTargetCusip() *string {
	if o == nil {
		return nil
	}
	return o.TargetCusip
...
func (o *EntryCapitalGainsCorporateActionGeneralInformation) GetTargetSymbolDescription() *string {
	if o == nil {
		return nil
	}
	return o.TargetSymbolDescription
...
type CapitalGains struct {
	...
	// Common fields for corporate actions
	CorporateActionGeneralInformation *EntryCapitalGainsCorporateActionGeneralInformation `json:"corporate_action_general_information,omitempty"`
...
func (o *CapitalGains) GetCashRate() *EntryCashRate {
	if o == nil {
		return nil
	}
	return o.CashRate
...
func (o *CapitalGains) GetCorporateActionGeneralInformation() *EntryCapitalGainsCorporateActionGeneralInformation {
	if o == nil {
		return nil
	}
	return o.CorporateActionGeneralInformation
...
func (o *CapitalGains) GetPaymentDate() *EntryPaymentDate {
	if o == nil {
		return nil
	}
	return o.PaymentDate
...
// EntryCashDividendCashRate - The rate (raw value, not a percentage, example: 50% will be .5 in this field) at which cash will be disbursed to the shareholder
type EntryCashDividendCashRate struct {
	// The decimal value, as a string; Refer to [Google’s Decimal type protocol buffer](https://github.com/googleapis/googleapis/blob/40203ca1880849480bbff7b8715491060bbccdf1/google/type/decimal.proto#L33) for details
	Value *string `json:"value,omitempty"`
}

func (o *EntryCashDividendCashRate) GetValue() *string {
	if o == nil {
		return nil
	}
	return o.Value
...
type EntryCashDividendPaymentDate struct {
	// Day of a month. Must be from 1 to 31 and valid for the year and month, or 0 to specify a year by itself or a year and month where the day isn't significant.
	Day *int `json:"day,omitempty"`
	// Month of a year. Must be from 1 to 12, or 0 to specify a year without a month and day.
	Month *int `json:"month,omitempty"`
...
func (o *EntryCashDividendPaymentDate) GetDay() *int {
	if o == nil {
		return nil
	}
	return o.Day
...
func (o *EntryCashDividendPaymentDate) GetMonth() *int {
	if o == nil {
		return nil
	}
	return o.Month
...
func (o *EntryCashDividendPaymentDate) GetYear() *int {
	if o == nil {
		return nil
	}
	return o.Year
...
type CashDividend struct {
	// The rate (raw value, not a percentage, example: 50% will be .5 in this field) at which cash will be disbursed to the shareholder
	CashRate *EntryCashDividendCashRate `json:"cash_rate,omitempty"`
	// Common fields for corporate actions
	...
	LongTermGain *bool `json:"long_term_gain,omitempty"`
	// The anticipated payment date at the depository
	PaymentDate *EntryCashDividendPaymentDate `json:"payment_date,omitempty"`
	// Identifies whether dividend income is potentially qualified for the lower maximum individual federal tax rate under the Jobs and Growth Tax Relief Reconciliation Act of 2003
	Qualified *bool `json:"qualified,omitempty"`
...
func (o *CashDividend) GetCashRate() *EntryCashDividendCashRate {
	if o == nil {
		return nil
	}
	return o.CashRate
...
func (o *CashDividend) GetPaymentDate() *EntryCashDividendPaymentDate {
	if o == nil {
		return nil
	}
	return o.PaymentDate
...
type EntryCashInLieuCorporateActionGeneralInformation struct {
	// A unique alphanumeric value that is assigned to uniquely identify each corporate action event
	CorporateActionID *string `json:"corporate_action_id,omitempty"`
	// Asset Id of the new security after the corporate action event is processed
	DisbursedAssetID *string `json:"disbursed_asset_id,omitempty"`
...
func (o *EntryCashInLieuCorporateActionGeneralInformation) GetCorporateActionID() *string {
	if o == nil {
		return nil
	}
	return o.CorporateActionID
...
func (o *EntryCashInLieuCorporateActionGeneralInformation) GetDisbursedAssetID() *string {
	if o == nil {
		return nil
	}
	return o.DisbursedAssetID
...
func (o *EntryCashInLieuCorporateActionGeneralInformation) GetDisbursedCusip() *string {
	if o == nil {
		return nil
	}
	return o.DisbursedCusip
...
func (o *EntryCashInLieuCorporateActionGeneralInformation) GetDisbursedSymbolDescription() *string {
	if o == nil {
		return nil
	}
	return o.DisbursedSymbolDescription
...
func (o *EntryCashInLieuCorporateActionGeneralInformation) GetTargetAssetID() *string {
	if o == nil {
		return nil
	}
	return o.TargetAssetID
...
func (o *EntryCashInLieuCorporateActionGeneralInformation) GetTargetCusip() *string {
	if o == nil {
		return nil
	}
	return o.TargetCusip
...
func (o *EntryCashInLieuCorporateActionGeneralInformation) GetTargetSymbolDescription() *string {
	if o == nil {
		return nil
	}
	return o.TargetSymbolDescription
...
type CashInLieu struct {
	// Common fields for corporate actions
	CorporateActionGeneralInformation *EntryCashInLieuCorporateActionGeneralInformation `json:"corporate_action_general_information,omitempty"`
}

func (o *CashInLieu) GetCorporateActionGeneralInformation() *EntryCashInLieuCorporateActionGeneralInformation {
	if o == nil {
		return nil
	}
	return o.CorporateActionGeneralInformation
...
const (
	...
	EntryDepositTypeExternalAch                     EntryDepositType = "EXTERNAL_ACH"
)
...
// EntrySideModifier - Indicates whether the trade is opening a new position or closing an existing position Should be populated if possible for trades; the side modifier for the trade
...
type TenderOfferType string

const (
	TenderOfferTypeTenderOfferTypeUnspecified TenderOfferType = "TENDER_OFFER_TYPE_UNSPECIFIED"
	TenderOfferTypeOddLotTender               TenderOfferType = "ODD_LOT_TENDER"
	TenderOfferTypeDutchAuction               TenderOfferType = "DUTCH_AUCTION"
)

func (e TenderOfferType) ToPointer() *TenderOfferType {
	return &e
}
...
type TenderOffer struct {
	...
	TenderOfferType *TenderOfferType `json:"tender_offer_type,omitempty"`
}
...
func (o *TenderOffer) GetTenderOfferType() *TenderOfferType {
	if o == nil {
		return nil
	}
...
type EntryTradeBrokerCapacity string

const (
	EntryTradeBrokerCapacityCapacityUnspecified EntryTradeBrokerCapacity = "CAPACITY_UNSPECIFIED"
	EntryTradeBrokerCapacityAgency              EntryTradeBrokerCapacity = "AGENCY"
	EntryTradeBrokerCapacityPrincipal           EntryTradeBrokerCapacity = "PRINCIPAL"
	EntryTradeBrokerCapacityMixed               EntryTradeBrokerCapacity = "MIXED"
)

func (e EntryTradeBrokerCapacity) ToPointer() *EntryTradeBrokerCapacity {
	return &e
}

// EntryTradePrevailingMarketPrice - The price for the instrument that is prevailing in the market
type EntryTradePrevailingMarketPrice struct {
	// The decimal value, as a string; Refer to [Google’s Decimal type protocol buffer](https://github.com/googleapis/googleapis/blob/40203ca1880849480bbff7b8715491060bbccdf1/google/type/decimal.proto#L33) for details
	Value *string `json:"value,omitempty"`
}

func (o *EntryTradePrevailingMarketPrice) GetValue() *string {
	if o == nil {
		return nil
	}
	return o.Value
...
type EntryTradePriceAdjustmentAmount struct {
	// The decimal value, as a string; Refer to [Google’s Decimal type protocol buffer](https://github.com/googleapis/googleapis/blob/40203ca1880849480bbff7b8715491060bbccdf1/google/type/decimal.proto#L33) for details
	Value *string `json:"value,omitempty"`
}

func (o *EntryTradePriceAdjustmentAmount) GetValue() *string {
	if o == nil {
		return nil
	}
	return o.Value
...
// EntryTradePriceAdjustmentType - The type of price adjustment being applied by the broker to the net price of the security
type EntryTradePriceAdjustmentType string

const (
	EntryTradePriceAdjustmentTypePriceAdjustmentTypeUnspecified EntryTradePriceAdjustmentType = "PRICE_ADJUSTMENT_TYPE_UNSPECIFIED"
	EntryTradePriceAdjustmentTypeMarkup                         EntryTradePriceAdjustmentType = "MARKUP"
	EntryTradePriceAdjustmentTypeMarkdown                       EntryTradePriceAdjustmentType = "MARKDOWN"
	EntryTradePriceAdjustmentTypeSalesLoad                      EntryTradePriceAdjustmentType = "SALES_LOAD"
)

func (e EntryTradePriceAdjustmentType) ToPointer() *EntryTradePriceAdjustmentType {
	return &e
}
...
type EntryPriceAdjustmentRecord struct {
	// Total monetary value of the price_adjustment
	PriceAdjustmentAmount *EntryTradePriceAdjustmentAmount `json:"price_adjustment_amount,omitempty"`
	// The percent at which the price was adjusted. Expressed as a number from 0.00-100 (rounded to 2 decimals)
	PriceAdjustmentPercent *EntryPriceAdjustmentPercent `json:"price_adjustment_percent,omitempty"`
	// The type of price adjustment being applied by the broker to the net price of the security
	PriceAdjustmentType *EntryTradePriceAdjustmentType `json:"price_adjustment_type,omitempty"`
}

func (o *EntryPriceAdjustmentRecord) GetPriceAdjustmentAmount() *EntryTradePriceAdjustmentAmount {
	if o == nil {
		return nil
	}
	return o.PriceAdjustmentAmount
...
func (o *EntryPriceAdjustmentRecord) GetPriceAdjustmentType() *EntryTradePriceAdjustmentType {
	if o == nil {
		return nil
	}
	return o.PriceAdjustmentType
...
type EntryTrade struct {
	...
	Broker *string `json:"broker,omitempty"`
	// Used to calculate broadridge blotter code
	BrokerCapacity *EntryTradeBrokerCapacity `json:"broker_capacity,omitempty"`
	// client usage area (intact). len 20
	ClientMemo *string `json:"client_memo,omitempty"`
	// Max Length 50 characters. Client provided order id present in exec reports
	ClientOrderID *string `json:"client_order_id,omitempty"`
	...
	OrderID *string `json:"order_id,omitempty"`
	// The price for the instrument that is prevailing in the market
	PrevailingMarketPrice *EntryTradePrevailingMarketPrice `json:"prevailing_market_price,omitempty"`
	// Information about any price adjustments applied to the security
...
func (o *EntryTrade) GetBrokerCapacity() *EntryTradeBrokerCapacity {
	if o == nil {
		return nil
	}
	return o.BrokerCapacity
...
func (o *EntryTrade) GetPrevailingMarketPrice() *EntryTradePrevailingMarketPrice {
	if o == nil {
		return nil
	}
	return o.PrevailingMarketPrice
...
// EntryTransfer - Used to record more generic transfers of funds or securities and details related to the transfer. The transfer type and activity_description can be used to provide more specific context
...
func (o *EntryTransfer) GetAdditionalInstructions() *string {
	if o == nil {
		return nil
	}
	return o.AdditionalInstructions
...
func (o *EntryTransfer) GetClientBrokerage() *string {
	if o == nil {
		return nil
	}
...
const (
	...
	EntryWithdrawalTypeExternalAch                     EntryWithdrawalType = "EXTERNAL_ACH"
)
...
func (o *Withdrawal) GetTotalDistribution() *bool {
	if o == nil {
		return nil
	}
...
type Entry struct {
	...
	CashInLieu *CashInLieu `json:"cash_in_lieu,omitempty"`
	...
	Transfer *EntryTransfer `json:"transfer,omitempty"`
...
func (o *Entry) GetAllocation() *Allocation {
	if o == nil {
		return nil
	}
	return o.Allocation
...
func (o *Entry) GetCashInLieu() *CashInLieu {
	if o == nil {
		return nil
	}
	return o.CashInLieu
...
func (o *Entry) GetTransfer() *EntryTransfer {
	if o == nil {
		return nil
	}
	return o.Transfer
