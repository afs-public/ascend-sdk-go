...
type AssetsListAssetsCorrespondentRequest struct {
...
func (o *AssetsListAssetsCorrespondentRequest) GetCorrespondentID() string {
	if o == nil {
		return ""
	}
...
func (o *AssetsListAssetsCorrespondentRequest) GetPageSize() *int {
	if o == nil {
		return nil
	}
	return o.PageSize
...
func (o *AssetsListAssetsCorrespondentRequest) GetPageToken() *string {
	if o == nil {
		return nil
	}
	return o.PageToken
...
func (o *AssetsListAssetsCorrespondentRequest) GetFilter() *string {
	if o == nil {
		return nil
	}
	return o.Filter
...
type AssetsListAssetsCorrespondentResponse struct {
	...
	Next func() (*AssetsListAssetsCorrespondentResponse, error)
}

func (o *AssetsListAssetsCorrespondentResponse) GetHTTPMeta() components.HTTPMetadata {
	if o == nil {
...
func (o *AssetsListAssetsCorrespondentResponse) GetListAssetsResponse() *components.ListAssetsResponse {
	if o == nil {
		return nil
	}
...
func (o *AssetsListAssetsCorrespondentResponse) GetStatus() *components.Status {
	if o == nil {
		return nil
	}
	return o.Status
