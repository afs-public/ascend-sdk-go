...
// ListAccountOrders - List Account Orders
...
func (s *Orders) ListAccountOrders(ctx context.Context, accountID string, filter *string, pageSize *int, pageToken *string, opts ...operations.Option) (*operations.OrderServiceListAccountOrdersResponse, error) {
	...
	res := &operations.OrderServiceListAccountOrdersResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListAccountOrdersResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListAccountOrdersResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Orders) ListCorrespondentOrders(ctx context.Context, correspondentID string, filter *string, pageSize *int, pageToken *string, opts ...operations.Option) (*operations.OrderServiceListCorrespondentOrdersResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/trading/v1/correspondents/{correspondent_id}/orders", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.OrderServiceListCorrespondentOrdersResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ListCorrespondentOrdersResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListCorrespondentOrdersResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
